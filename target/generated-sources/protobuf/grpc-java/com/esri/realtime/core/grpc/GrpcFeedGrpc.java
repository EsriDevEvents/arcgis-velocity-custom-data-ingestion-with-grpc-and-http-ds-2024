...
public final class GrpcFeedGrpc {
  ...
  public static final java.lang.String SERVICE_NAME = "esri.realtime.core.grpc.GrpcFeed";
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default io.grpc.stub.StreamObserver<com.esri.realtime.core.grpc.Request> stream(
     ...
     * </pre>
     */
    default void send(com.esri.realtime.core.grpc.Request request,
        io.grpc.stub.StreamObserver<com.esri.realtime.core.grpc.Response> responseObserver) {
  ...
  /**
   * Base class for the server implementation of the service GrpcFeed.
   */
  public static abstract class GrpcFeedImplBase
      implements io.grpc.BindableService, AsyncService {

    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return GrpcFeedGrpc.bindService(this);
    }
  }

  /**
   * A stub to allow clients to do asynchronous rpc calls to service GrpcFeed.
   */
  public static final class GrpcFeedStub
      extends io.grpc.stub.AbstractAsyncStub<GrpcFeedStub> {
  ...
  /**
   * A stub to allow clients to do synchronous rpc calls to service GrpcFeed.
   */
  public static final class GrpcFeedBlockingStub
      extends io.grpc.stub.AbstractBlockingStub<GrpcFeedBlockingStub> {
  ...
  /**
   * A stub to allow clients to do ListenableFuture-style rpc calls to service GrpcFeed.
   */
  public static final class GrpcFeedFutureStub
      extends io.grpc.stub.AbstractFutureStub<GrpcFeedFutureStub> {
  ...
  private static final class GrpcFeedMethodDescriptorSupplier
    ...
    GrpcFeedMethodDescriptorSupplier(java.lang.String methodName) {
